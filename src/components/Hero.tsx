    ...
    <section className="mx-auto my-4 h-screen max-w-7xl border border-black">
      <div className="flex h-full">
        <div className="flex h-full w-[40%] flex-col justify-center text-pretty border border-black">
          ...
          <div>
            <button className="mr-6 rounded-sm bg-orange-500 px-7 py-4  font-bold text-white shadow-[5px_5px_0_0_rgba(0,0,0,.2)] transition-all duration-150 hover:brightness-95 active:scale-95 active:shadow-none">
            ...
            <button className=" rounded-sm bg-black px-7 py-4 font-bold  text-white outline outline-2 outline-offset-[-2px] outline-black transition-all duration-300 hover:bg-white hover:text-black active:scale-95">
              <span className="flex items-center gap-2">
