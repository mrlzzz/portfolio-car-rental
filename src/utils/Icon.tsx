...
const carLogo = (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="h-10 w-10 transition-all hover:text-orange-500 lg:h-12 lg:w-12"
  >
...
iconList.set("arrDown", arrDown);
iconList.set("arrUp", arrUp);
iconList.set("phone", phone);
iconList.set("mail", mail);
iconList.set("carLogo", carLogo);
